...
$(document).ready(function() {
  ...
  // $(document).ready(function() {
    $('.tooltip, .tooltip_gris').tooltipster({
...
function cargarDatosPrincipales(id){
  console.log("cargarDatosPrincipales id recibida=["+id+"]");
      ...
      $('.slider_content').fadeOut("slow", function(){
        $('#path_img').html('<a href="http://www.alfaguara.com/uploads/ficheros/libro/primeras-paginas/201401/primeras-paginas-cortazar-z.pdf" target="_blank"><img src="'+libros[id].path_img+'"></a>');
    ...
    $('#slogan').html(libros[id].slogan);
        ...
        $('#link_comprar').html('<a class="button" href="'+libros[id].link_comprar+'">entrar en el club de lectura</a>');

        ///////////
        // CAJAS //
        ///////////
        // Posiciones en json => X en numero cajas[X]
          $('#caja_roja').html(libros[id].cajas[0].caja_roja.texto+'<a target="_blank" class="button_box1" href="'+libros[id].cajas[0].caja_roja.link_ver_mas+'" style="">Ver más</a>');

          $('#caja_azul').html('<img style="margin:0 auto 0 auto" src='+libros[id].cajas[1].caja_azul.link_comprar+' width="87" height="110" /><br/><a target="_blank" class="button_box3" href="'+libros[id].cajas[1].caja_azul.link_ver_mas+'" style="">Comprar</a>');

          $('#caja_lima').html(libros[id].cajas[2].caja_lima.texto+'<br/><br/><iframe src="https://embed.spotify.com/?uri=spotify:user:editorialalfaguara:playlist:2YAw4uqQEY9RcRmLepYfB6" width="220" height="200" frameborder="0" allowtransparency="true"></iframe>');

          $('#caja_rosa').html(libros[id].cajas[3].caja_rosa.texto+'<a target="_blank" class="button_box2" href="'+libros[id].cajas[3].caja_rosa.link_ver_mas+'" style="">Ver más</a>');

          $('#caja_verde').html(libros[id].cajas[4].caja_verde.texto+'<a target="_blank" class="button_box2" href="'+libros[id].cajas[4].caja_verde.link_ver_mas+'" style="">Ver más</a>');
